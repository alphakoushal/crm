                            ...
                            <div class="form-check">
                              ...
                              <div class="flex-1">
                                ...
                                <p class="text-sm text-gray-500 mt-1">
                                  Available to all team members. Others can
                                  view, use, and modify this template.
                                </p>
                              </div>
                            </div>
                            <div class="form-check">
                      ...
                      <div className="col-12">
                        <div className="p-4 mt-n4 text-center">
                          <div className="position-relative mt-n4">
                            <button
                              onClick={addTable}
                              className="rounded-circle border border-3 border-white btn bg-primary-subtle text-primary  btn-sm"
                              title="View Code"
                            >
                          ...
                          {tables.map((tableData, index) => (
                            <DynamicTable
                              key={index}
                              tableData={tableData}
                              updateTable={(newRows, type) =>
                                updateTable(index, newRows, type)
                              }
                            />
                          ))}
                        </div>
                      ...
                      <div className="m-auto mt-3">
                        ...
                        >
                          ...
                          >
                            ...
                            <i
                              className={`ti ti-refresh rotate ms-2 ${validate.loader}`}
                            ></i>
                          </div>
                        </button>
                      </div>
