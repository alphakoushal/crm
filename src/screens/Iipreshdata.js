...
import { userprofileupdate } from "../reducers/Userdata.js";
import Uploadsidebar from "../component/Uploadsidebar.js";
import Commentmodal from "../component/modals/comments.js";
import Uploaddata from "../services/uploaddata.js";
import Style from "../component/style/style.js";
...
import Sidebarprofile from "../component/modals/Sidebarprofile.js";
import TransferiipEmailbox from "../component/modals/Transferuniqueiip.js";
import TransferiipDupeemailprocess from "../component/modals/Transferdupeiip.js";
...
{showeditmodal.state==true ? <Editmodal alldata={d2} changedata={changedata} show={showeditmodal} fn={editinfo}></Editmodal> : <></> }
    ...
    {defaultdata.opensendmailbox ? <TransferiipEmailbox page='freshdata' platform={platform} alldata={d} changedata={changedata} closeemailsendbox={closeemailsendbox} emailsdata={d.slice(0, document.querySelector('#totalsending').value)} fn={closeemailsendbox}></TransferiipEmailbox> : <></>}
    {defaultdata.opendupesendmailbox ? <TransferiipDupeemailprocess page='freshdata' platform={platform} alldata={d} changedata={changedata} closedupeemailsendbox={closedupeemailsendbox} emailsdata={d} fn={closedupeemailsendbox}></TransferiipDupeemailprocess> : <></>}
