...
const Editemailemplate = () => {
  ...
  const fetchtemps = async (id) => {
    let data = await Fetchdata.fetchtemp({ id: id }).then((response) => {
      return response;
    });
    data = data.data.data;
  ...
  async function submittemplate() {
    ...
    let title = document.querySelector("#emailtitle").value;
     let visibility = document.querySelector("input[name='visibility']:checked");
    ...
    if (restdata.loader == "block") {
      ...
      setvalidate((validate) => ({
        ...validate,
        status: true,
        message: "Please Choose Client Type",
      }));
    } else if (visibility == "") {
      setvalidate((validate) => ({
        ...validate,
        status: true,
        message: "Please Choose template visibility",
      }));
    } else if (editorData == "") {
      setvalidate((validate) => ({
        ...validate,
      ...
      let res = await Uploaddata.mailtemplate(formdata).then((resposne) => {
        return resposne;
      });
      if (res.data.success) {
        setvalidate((prev) => ({
              ...
              <div className="col-12">
                <div className="card">
                  <div className="card-body">
                    ...
                    >
                      <small className="border rounded me-1 mb-1 bg-light p-1">
                        @contact_person@
                      </small>
                      <small className="border rounded me-1 mb-1 bg-light p-1">
                        @title@
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-3">
                        <div className="form-floating mb-3">
                          <input
                            ...
                            id="emailsubject"
                            onChange={(e) =>
                              updatestate(e.target.value, "subject")
                            }
                            value={restdata.subject}
                            placeholder="Enter Name here"
                          />
                      ...
                      <div className="col-md-3">
                        <div className="form-floating mb-3">
                          <select
                            onChange={(e) =>
                              updatestate(e.target.value, "clienttype")
                            }
                          ...
                          >
                            ...
                            <option
                              selected={
                                restdata.clienttype == "1" ? "selected" : ""
                              }
                              value="1"
                            >
                              Agent
                            ...
                            <option
                              selected={
                                restdata.clienttype == "2" ? "selected" : ""
                              }
                              value="2"
                            >
                              Individual
                            ...
                            <option
                              selected={
                                restdata.clienttype == "3" ? "selected" : ""
                              }
                              value="3"
                            >
                              Both
                      ...
                      <div className="col-md-3">
                        <div className="form-floating">
                          <select
                            onChange={(e) =>
                              updatestate(e.target.value, "templatetype")
                            }
                            className="form-select mr-sm-2"
                            id="templatetype"
                          >
                            ...
                            <option
                              selected={
                                restdata.templatetype == "1" ? "selected" : ""
                              }
                              value="1"
                            >
                              Individual
                            ...
                            <option
                              selected={
                                restdata.templatetype == "2" ? "selected" : ""
                              }
                              value="2"
                            >
                              Dupe
                        ...
                        <div class="mb-3">
                          ...
                          <div class="form-check">
                            <input
                              ...
                              checked={restdata.visibility == "1"}
                              name="visibility"
                              onChange={(e) =>
                              updatestate('1', "visibility")
                            }
                              value={"1"}
                            />
                            <div class="flex-1">
                              ...
                              <p class="text-sm text-gray-500 mt-1">
                                Available to all team members. Others can view,
                          ...
                          <div class="form-check">
                            <input
                              type="radio"
                              class="form-check-input"
                              checked={restdata.visibility == "2"}
                              name="visibility"
                              onChange={(e) =>
                              updatestate('2', "visibility")
                            }
                              value={"2"}
                            />
                            <div class="flex-1">
                              ...
                              <p class="text-sm text-gray-500 mt-1">
                                Only visible to you. Other team members cannot
                                access or use this template.
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="m-auto mt-3">
                          ...
                          >
                            ...
                            >
                              ...
                              <i
                                className={`ti ti-refresh rotate ms-2 ${restdata.loader}`}
                              ></i>
                            </div>
                          </button>
                        </div>
