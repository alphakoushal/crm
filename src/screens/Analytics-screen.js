...
const Analyticdashboard = () => {
  ...
  {
    code=((code!='N/A' && code!='' && typeof(code)!='undefined' && typeof(code)=='string') ? code?.split(' ') : '');
              ...
              <TableVirtuoso
                ...
                fixedHeaderContent={() => (
                  <>
                    ...
                    <tr>
                      ...
                      <Filterinput fieldname={'First Name'} id={'0'} filterdata={filterdata} sortdata={sortdata}></Filterinput>
                      <Filterinput fieldname={'Last Name'} id={'1'} filterdata={filterdata} sortdata={sortdata}></Filterinput>
                      <Filterinput fieldname={'Company'} id={'2'} filterdata={filterdata} sortdata={sortdata}></Filterinput>
                      <Filterinput fieldname={'Designation'} id={'3'} filterdata={filterdata} sortdata={sortdata}></Filterinput>
                      <Filterinput fieldname={'Field/Expertise'} id={'4'} filterdata={filterdata} sortdata={sortdata}></Filterinput>
                      <Filterinput fieldname={'Technology'} id={'5'} filterdata={filterdata} sortdata={sortdata}></Filterinput>
                      <Filterselect defaultv={defaultvalue.contactinfostatus} values={defaultdata.cio} event={handlecio} fieldname={'Contact Info of'} id={'6'} filterdata={filterdata} sortdata={sortdata}></Filterselect>
                      ...
                      <Filterinput fieldname={'Email ID'} id={'8'} filterdata={filterdata} sortdata={sortdata}></Filterinput>
                      <Filterinput fieldname={'Additional Email ID'} id={'27'} filterdata={filterdata} sortdata={sortdata}></Filterinput>
                      <Filterinput fieldname={'Web Domain'} id={'9'} filterdata={filterdata} sortdata={sortdata}></Filterinput>
                      <Filterinput fieldname={'Phone No'} id={'10'} filterdata={filterdata} sortdata={sortdata}></Filterinput>
                      <Filterinput fieldname={'Alt Phone No.'} id={'11'} filterdata={filterdata} sortdata={sortdata}></Filterinput>
                      <Filterinput fieldname={'City'} id={'12'} filterdata={filterdata} sortdata={sortdata}></Filterinput>
                      <th style={{ background: "white" }}>
                        <div className="headers">
                        Country{" "}
                          <i
                      ...
                      <Filterinput fieldname={'Timezone'} id={'13'} filterdata={filterdata} sortdata={sortdata}></Filterinput>
                      <Filterinput fieldname={'Linkedin Profile'} id={'14'} filterdata={filterdata} sortdata={sortdata}></Filterinput>
                      <Filterinput fieldname={'First Email Date'} id={'15'} filterdata={filterdata} sortdata={sortdata}></Filterinput>
                      <Filterinput fieldname={'FollowUp date'} id={'16'} filterdata={filterdata} sortdata={sortdata}></Filterinput>
                      <Filterinput fieldname={'Next Follow Up'} id={'17'} filterdata={filterdata} sortdata={sortdata}></Filterinput>
                      <th style={{ background: "white" }}>
                        <div className="headers">
                          Email Status
                          <i
                      ...
                      <Filterinput fieldname={'Comment'} id={'21'} filterdata={filterdata} sortdata={sortdata}></Filterinput>
                      <Filterinput fieldname={'Assigned to'} id={'26'} filterdata={filterdata} sortdata={sortdata}></Filterinput>
                      <Filterinput fieldname={'Last Name Sent Account'} id={'22'} filterdata={filterdata} sortdata={sortdata}></Filterinput>
                      <Filterinput fieldname={'Last Email Sent Account'} id={'23'} filterdata={filterdata} sortdata={sortdata}></Filterinput>
                      <Filterinput fieldname={'Account History'} id={'24'} filterdata={filterdata} sortdata={sortdata}></Filterinput>
                      <Filterinput fieldname={'Cron status'} id={'25'} filterdata={filterdata} sortdata={sortdata}></Filterinput>
                ...
                itemContent={(index, user) => (
                  <>
                    ...
                    >
                      <img className='flagwidth' src={`https://www.anuation.com/crm/assets/flags/${user[13].toLowerCase()}.png`}/>
                      <a
                        target="blank"
                        href={
                    ...
                    <td
                      ...
                      className={`column-value ${tablesetting.countred(user[9], 9, d) && typeof(user[9])!='undefined' && user[9]!='' ? "red-dupe" : ""
                        }`}
                      style={{}}
                    >
                      {user[9]}
                    ...
                    <td
                      ...
                      className={`cursor-pointer text-primary column-value align-items-center ${tablesetting.countred(user[11], 11, d) && user[11]!='' ? "red-dupe" : ""
                        }`}
                      style={{}}
                    >
                      <i className="ti ti-refresh rotate hide profilefetch"></i>
                   ...
                   {user[14]}
                    ...
                    <td
                      ...
                      style={{}}
                    >
                      {callstatus[user[20]] ?? (user[20]!='_blank' ? user[20] : "")}
                    </td>
                    <td
                      onClick={(e) => {
                    ...
                    <td
                      onClick={(e) => {
                        pickvalue(e, 23, 26,{key:'Last Email Sent Account'});
                      }}
                      className="column-value"
                      style={{}}
                    >
