...
const Editanalytictemplate =() =>{
    ...
    const fetchtemps = async (id) =>{
        let data= await Fetchdata.fetchanalytictemplatedata({'id':id,'posttype':'fetchanalytictemplatedata'}).then((response)=>{ return response});
        data=data.data.data;
    ...
    async function submittemplate()
    {
       ...
       else
       {
        ...
        let formdata={
         ...
         let res =await Uploaddata.analyticmailtemplate(formdata).then((resposne)=>{return resposne});
...
export default Editanalytictemplate;