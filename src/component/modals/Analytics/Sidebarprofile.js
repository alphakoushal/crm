 ...
 useEffect(()=>{
  ...
  gethistory(email,type);
    ...
    return(
        ...
        <div onClick={()=>setpopver((prev)=>({...prev,show:false}))} className="offcanvas offcanvas-end profile-bar profilesidebar show" tabIndex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
