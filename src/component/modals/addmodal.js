...
const Addmodal = function({fn,state}){
...
{
    e.preventDefault();
let web=document.querySelector('#weblink').value;let app=document.querySelector('#Aplication_number').value;
let invention_title=document.querySelector('#invention_title').value;let country_code=document.querySelector('#country_code').value;
let APPLICANT_NAME=document.querySelector('#APPLICANT_NAME').value;let APPLICANT_STATUS=document.querySelector('#APPLICANT_STATUS').value;
let PRIOTITY_DATE=document.querySelector('#PRIOTITY_DATE').value;let d30=document.querySelector('#d30').value;
let d31=document.querySelector('#d31').value;let cf=document.querySelector('#cf').value;
let cl=document.querySelector('#cl').value;let Company_Name=document.querySelector('#Company_Name').value;
let email=document.querySelector('#email').value;let PHONE_NO=document.querySelector('#PHONE_NO').value;
let CONTACT_INFO_OF=document.querySelector('#CONTACT_INFO_OF').value;let agent_Name=document.querySelector('#agent_Name').value;
let agent_email_ID=document.querySelector('#agent_email_ID').value;let agent_PHONE_NO=document.querySelector('#agent_PHONE_NO').value;
let PAGES=document.querySelector('#PAGES').value;let CLAIMS=document.querySelector('#CLAIMS').value;
let PRIORITY=document.querySelector('#PRIORITY').value;let DRAWINGS=document.querySelector('#DRAWINGS').value;
let ISR=document.querySelector('#ISR').value;let REFERENCE_NUMBER=document.querySelector('#REFERENCE_NUMBER').value;
var formData = {'s_assign_to':auth.userid,'Restrict':'','publication_number': web,'invention_title': invention_title,'country_code': country_code,'Aplication_number': app,'CONTACT_PERSON_FIRST': cf,'CONTACT_PERSON_Last_NAME': cl,'Email_ID': email,'PHONE_NO': PHONE_NO,'a_p_h_n':agent_PHONE_NO,'agent_name':agent_Name,'agent_email_id':agent_email_ID,'PRIOTITY_DATE': PRIOTITY_DATE,'DEADLINE_30_month': d30,'DEADLINE_31_month': d31,'PAGES': PAGES,'CLAIMS': CLAIMS,'PRIORITY': PRIORITY,'DRAWINGS': DRAWINGS,'APPLICANT_NAME': APPLICANT_NAME,'APPLICANT_STATUS': APPLICANT_STATUS,'Company_Name': Company_Name,'CONTACT_INFO_OF': CONTACT_INFO_OF,'ISR': ISR,'REFERENCE_NUMBER': REFERENCE_NUMBER,'type': 'add_pct'};
if(web=='')
        {
        ...
        {
            setvalidate((validate)=>({...validate,status:true,message:'Enter title'}));
        }
        else if(country_code=='')
        {
            setvalidate((validate)=>({...validate,status:true,message:'Enter country code'}));
        }
        else if(email=='')
        {
    ...
    <div className="modal-dialog modal-lg modal-dialog-centered" role="document">
        ...
        <div className="row">
                            ...
                            <div className="">
                                    ...
                                    <div className="row">
                                    <div className="form-group col-md-4">
                                                <label className="col-sm-12" htmlFor="PRIOTITY_DATE">Priority Date1:</label>
                                                <div className="col-sm-12 error_field_group" id="PRIOTITY_DATE-group" style={{"zIndex":"98"}}>
                                                    <input type="date" onChange={(e)=>{deadlinedate(e.target.value)}} autocomplete="off" className="form-control restrictedinput validate-field" id="PRIOTITY_DATE" name="PRIOTITY_DATE" placeholder="PRIOTITY DATE"/>
                                                </div>
                                            </div>
                                    <div className="form-group col-md-4">
                                                ...
                                                <div className="col-sm-12 error_field_group" id="DEADLINE_30_month-group">
                                                    ...
                                                    <input type="text" className="form-control validate-field" autocomplete="off" id="d30" placeholder="DEADLINE - 30 mth"/>
                                                </div>
                                            </div>
                                    <div className="form-group col-md-4">
                                                ...
                                                <div className="col-sm-12 error_field_group" id="DEADLINE_31_month-group">
                                                    ...
                                                    <input type="text" className="form-control validate-field" autocomplete="off" id="d31" placeholder="DEADLINE- 31 month"/>
                                                </div>
                                            </div>
                                    </div>
                                    <div className="row">
